      ...
      <div>
        ...
        <div className="text-lg md:text-xl px-7 sm:px-16 lg:px-28 font-medium">
          ...
          <div className="mt-24">
            ...
            <div className="mt-10">
              <p className="font-bold text-2xl sm:text-3xl mb-10 text-center">
                Homepage
              </p>
              <figure>
                <Image src={home} alt="" />
            ...
            <div className="mt-16">
              ...
              <div className="relative">
                ...
                <p className="font-bold text-lg sm:text-2xl md:absolute md:w-1/3 top-10 right-20">
                  Users can book ticket in 3 easy steps on one page
                </p>
              </div>
              <div className="sm:flex sm:flex-row-reverse items-center justify-between mt-10">
                ...
                <p className="font-bold text-lg sm:text-2xl sm:w-2/5 sm:mr-5 md:mr-20">
                  After successful selection, users can then view checkout
                  details. add ticket to cart or add food and then proceed to
                  checkout
                </p>
              </div>
            </div>
            <div className="mt-16">
              ...
              <div className="sm:flex items-center justify-between">
                ...
                <p className="font-bold text-lg sm:text-2xl sm:w-2/5">
                  After checking out, users proceed to pay for their e-tickets
                  with either creditcard, paypal or coupons gifted
                </p>
              </div>
              <div className="mt-16">
                <p className="font-bold text-2xl sm:text-3xl mb-10 text-center">
            ...
            <div className="mt-24">
              ...
              <p className="text-center mt-5">
                I conducted just one round of usability study to help me
                redefine my wireframes into creating smooth and accessible
                mockups for the users
              </p>
              <div className="mt-10">
                ...
                <div className="space-y-6 mt-5">
                  {usabilityStudy.map((text, i) => (
                    <div key={i} className="flex space-x-3 items-center">
                      <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full grid place-items-center text-lg sm:text-2xl text-primary-dark bg-blue-500 font-bold">
                        {i + 1}
                      </div>
        ...
        <footer className="mt-28 bg-red-500 flex flex-col text-lg sm:text-xl items-center px-7 sm:px-20 py-14 font-semibold text-center">
          <figure className="w-32 sm:w-44 mb-5">
            <Image src={yossee} alt="" />
          </figure>
          <p>
            Thank you for taking your time to read and review my case study. If
            you would like to get in touch with me to ask any questions or
            collaborate on a project, you can reach out to me by:
          </p>
          <p className="mt-7">
            Email:{" "}

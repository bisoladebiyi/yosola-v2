...
const ContactPopup: React.FC<IContact> = ({
  message,
  setMessage,
  domRef,
  setShowPopUp,
  ...
  return (
    <div
      className="popup rounded-md p-10 w-11/12 sm:w-1/2 md:w-2/5"
      ref={domRef}
    >
      <form action="" onSubmit={sendEmail} ref={form}>
        ...
        <div className="flex space-x-4">
          ...
          <button
            onClick={close}
            className="flex bg-white text-primary border border-primary p-3 rounded-md items-center font-medium"
          >
            Cancel
          </button>
        </div>
